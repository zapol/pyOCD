...
FLASH_ALGO = {
    ...
    0x7200f44f, 0xf86af000, 0xbf182800, 0xbd802001, 0x4614b570, 0x0441460d, 0x4670f020, 0xf240d10d,
...
class LPC5528(LPC5500Family):
    ...
    def __init__(self, session):
        super(LPC5528, self).__init__(session, self.MEMORY_MAP)
        self._svd_location = SVDFile.from_builtin("LPC5528.xml")
